...
We make sure that people can enjoy playing the World of Darkness systems in Foundry. Currently, we provide support for:
* Vampire the Masquerade 5th Edition
* Hunter the Reckoning 5th Edition
* Werewolf the Apocalypse 5th Edition

With hopes to support any future 5th edition World of Darkness systems, as well as future World of Darkness editions, too!

## Contributors

The lead system developer is [Veilza](https://github.com/Veilza), and the original creator of the World of Darkness 5e system is [Rayji96](https://github.com/Rayji96).

There's lots of other people who contribute, too, and you can find the full list of them down [here](https://github.com/WoD5E-Developers/.github/blob/main/contributors.md)!
